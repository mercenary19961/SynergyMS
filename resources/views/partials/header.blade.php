...
<header class="bg-gradient-to-r from-pink-600 to-orange-500 p-4 flex justify-between items-center shadow-md">
    ...
    <div class="relative flex items-center space-x-4">
        ...
        <div x-data="{ notificationOpen: false }" class="relative">
            ...
            <div @click.away="notificationOpen = false" @click="notificationOpen = !notificationOpen" class="relative cursor-pointer">
                <!-- Orange SVG Notification Icon -->
            ...
            <div x-show="notificationOpen" class="absolute right-0 mt-2 w-80 bg-white border border-gray-300 rounded-md shadow-lg"
                ...
                @notificationUpdated.window="notificationOpen = true"
            >
                <div class="p-4">
