...
<div class="flex h-screen">
    <div class="flex-1 p-6 bg-gray-100">
        ...
        <x-title-with-back title="Edit Event" />
        ...
        <form action="{{ route('admin.events.update', $event->id) }}" method="POST" class="space-y-4">
            ...
            <div class="flex flex-col md:flex-row md:space-x-4">
                ...
                <div class="md:w-1/2">
                    ...
                    <input type="text" name="name" id="name" class="mt-1 block w-full border border-gray-300 focus:border-orange-500 focus:outline-none rounded-md p-2" value="{{ old('name', $event->name) }}">
                </div>

                <!-- Event Description -->
                <div class="md:w-1/2">
                    <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                    <textarea name="description" id="description" class="mt-1 block w-full border border-gray-300 focus:border-orange-500 focus:outline-none rounded-md p-2">{{ old('description', $event->description) }}</textarea>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row md:space-x-4">
                ...
                <div class="md:w-1/2">
                    ...
                    <input type="datetime-local" name="start_date" id="start_date" class="mt-1 block w-full border border-gray-300 focus:border-orange-500 focus:outline-none rounded-md p-2" 
                ...
                <div class="md:w-1/2">
                    ...
                    <input type="datetime-local" name="end_date" id="end_date" class="mt-1 block w-full border border-gray-300 focus:border-orange-500 focus:outline-none rounded-md p-2" 
            ...
            <div class="flex flex-col md:flex-row md:space-x-4">
                ...
                <div class="md:w-1/2 relative" x-data="{ open: false, selectedSector: '{{ old('target_role', $event->target_role) ?? 'Select Sector' }}' }">
                ...
                <div class="md:w-1/2 flex items-center mt-6">
                    ...
                    <input type="checkbox" name="is_general" id="is_general" class="mr-2 h-5 w-5 text-orange-500 focus:ring-orange-500 border-gray-300 rounded" {{ old('is_general', $event->is_general) ? 'checked' : '' }}>
                    <label for="is_general" class="block text-sm font-medium text-gray-700">General Event</label>
                </div>

            </div>

            <x-form.button-submit label="Update Event" />
        </form>
    </div>
</div>
@endsection
