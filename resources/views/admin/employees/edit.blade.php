    ...
    <div class="flex-1 p-6 bg-gray-100 overflow-auto">
        ...
        @if ($employee->user->image)
            <div class="mb-2">
                ...
                <img loading="lazy" src="{{ $employee->user->image ? asset('storage/' . $employee->user->image) . '?v=' . time() : asset('images/default_user_image.png') }}" class="rounded-full object-cover h-40 w-40 mr-2">
            </div>
        @endif
